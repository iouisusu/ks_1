...
train_parameters = {
    ...
    "image_enhance_strategy": {  # 图像增强相关策略
        ...
        "hue_prob": 0.5,  # 色度调整概率
        "hue_delta": 18,  # 色度调整范围
        "contrast_prob": 0.5,  # 对比度调整概率
        "contrast_delta": 0.5,  # 对比度调整范围
        "saturation_prob": 0.5,  # 饱和度调整概率
        "saturation_delta": 0.5,  # 饱和度调整范围
        "brightness_prob": 0.5,  # 亮度调整概率
        "brightness_delta": 0.125,  # 亮度调整范围
        "rotate_prob": 0.5,  # 旋转概率
        "rotate_range": 14  # 旋转角度范围
